 ...
 * @author Daniel Abitz
 */
class FastDirectedMultiGraphStructureTest {

    private static FastDirectedMultiGraphStructure<SimpleNode, SimpleEdge<SimpleNode>, String> newGraphStructure() {
        return new FastDirectedMultiGraphStructure<>(
                HashSet::new,
                HashSet::new,
                HashMap::new,
                HashMap::new,
    ...
    @Test
    void testAddNode() {
        FastDirectedMultiGraphStructure<SimpleNode, SimpleEdge<SimpleNode>, String> gs = newGraphStructure();
