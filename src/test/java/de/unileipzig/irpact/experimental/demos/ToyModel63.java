 ...
 */
@Disabled
public class ToyModel63 {

    private static InRoot createRoot() {
        //files
        InPVFile pvFile = new InPVFile("Barwertrechner");
        InSpatialTableFile tableFile = new InSpatialTableFile("testdaten_Test_6_3");
        ...
        K.setEnvironmentalConcern(diraq0);                      //A4
        K.a5 = diraq1;                                          //A5    //!
        K.a6 = diraq1;                                          //A6    //!
        ...
        K.setAdoptionThreshold(diraq06);                        //D4
    ...
    @Test
    void runThisModel() {
        ToyModelUtil.run("test_6_3", createRoot());
    }
}
