 ...
 */
@Disabled
public class ToyModel54 {

    private static InRoot createRoot() {
        //files
        InPVFile pvFile = new InPVFile("Barwertrechner");
        InSpatialTableFile tableFile = new InSpatialTableFile("testdaten_Test_5_4");
        ...
        InConstantUnivariateDistribution diraq075 = new InConstantUnivariateDistribution("diraq07", 0.75);
        InConstantUnivariateDistribution diraq08 = new InConstantUnivariateDistribution("diraq07", 0.8);
        InConstantUnivariateDistribution diraq1 = new InConstantUnivariateDistribution("diraq1", 1);
        InConstantUnivariateDistribution diraqX = new InConstantUnivariateDistribution("diraqX", 0.5);
        ...
        A.setDependentJudgmentMaking(diraq08);                  //A3
        ...
        K.setDependentJudgmentMaking(diraq075);                 //A3
        ...
        InAffinityEntry[] affinities = new InAffinityEntry[]{
                ...
                new InNameSplitAffinityEntry(S, A, 0.5),
                new InNameSplitAffinityEntry(S, S, 0.5),
                new InNameSplitAffinityEntry(S, K, 0),

                new InNameSplitAffinityEntry(K, A, 0),
                new InNameSplitAffinityEntry(K, S, 0.4),
                new InNameSplitAffinityEntry(K, K, 0.6)
        };


        //Population
        InFixConsumerAgentPopulationSize[] populationSizes = new InFixConsumerAgentPopulationSize[] {
                new InFixConsumerAgentPopulationSize("A_pop", A, 5),
                new InFixConsumerAgentPopulationSize("S_pop", S, 6),
                new InFixConsumerAgentPopulationSize("K_pop", K, 4)
        };
        ...
        topology.setNumberOfTies(
                new InNumberOfTies("S_tie", S, 5),
                new InNumberOfTies("A_tie", A, 6),
                new InNumberOfTies("K_tie", K, 4)
        );
        ...
        root.setAgentPopulationSizes(populationSizes);
    ...
    @Test
    void runThisModel() {
        ToyModelUtil.run("test_5_4", createRoot());
    }
}
