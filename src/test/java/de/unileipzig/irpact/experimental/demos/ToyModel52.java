 ...
 */
@Disabled
public class ToyModel52 {

    private static InRoot createRoot() {
        //files
        InPVFile pvFile = new InPVFile("Barwertrechner");
        InSpatialTableFile tableFile = new InSpatialTableFile("testdaten_Test_5_2");
        ...
        InConstantUnivariateDistribution diraqX = new InConstantUnivariateDistribution("diraqX", 0.15);
    ...
    @Test
    void runThisModel() {
        ToyModelUtil.run("test_5_2", createRoot());
    }
}
