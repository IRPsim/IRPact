 ...
 */
@Disabled
public class ToyModel51 {

    private static InRoot createRoot() {
        //files
        InPVFile pvFile = new InPVFile("Barwertrechner");
        InSpatialTableFile tableFile = new InSpatialTableFile("testdaten_Test_5_1");
        ...
        InConstantUnivariateDistribution diraqX = new InConstantUnivariateDistribution("diraqX", 0.2);
        ...
        InAffinityEntry[] affinities = new InAffinityEntry[]{
                ...
                new InNameSplitAffinityEntry(S, A, 1),
                new InNameSplitAffinityEntry(S, S, 0),
                new InNameSplitAffinityEntry(S, K, 0),

                new InNameSplitAffinityEntry(K, A, 0),
                new InNameSplitAffinityEntry(K, S, 0),
                new InNameSplitAffinityEntry(K, K, 1)
        };
        ...
        topology.setNumberOfTies(
                new InNumberOfTies("S_tie", S, 0),
                new InNumberOfTies("A_tie", A, 0),
                new InNumberOfTies("K_tie", K, 0)
        );
    ...
    @Test
    void runThisModel() {
        ToyModelUtil.run("test_5_1", createRoot());
    }
}
