...
class Point2DTest {
    ...
    void testManhattenMetrik() {
        ...
        assertEquals(7, Point2D.distance(Metric.MANHATTEN, p0, p1));
        assertEquals(7, Point2D.distance(Metric.MANHATTEN, p1, p0));
    }
    ...
    void testEuclideanMetrik() {
        ...
        assertEquals(5, Point2D.distance(Metric.EUCLIDEAN, p0, p1));
        assertEquals(5, Point2D.distance(Metric.EUCLIDEAN, p1, p0));
    }
    ...
    void testMaximumMetrik() {
        Point2D p0 = new Point2D(2, 3);
        Point2D p1 = new Point2D(5, 7);
        assertEquals(4, Point2D.distance(Metric.MAXIMUM, p0, p1));
        assertEquals(4, Point2D.distance(Metric.MAXIMUM, p1, p0));
    }
