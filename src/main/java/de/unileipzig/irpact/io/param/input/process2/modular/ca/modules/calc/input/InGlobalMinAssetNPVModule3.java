...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALMINASSETNPV;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALMINASSETNPV)
public class InGlobalMinAssetNPVModule3 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalMinAssetNPVModule3() {
    }

    public InGlobalMinAssetNPVModule3(String name) {
        setName(name);
    }

    public InGlobalMinAssetNPVModule3(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalMinAssetNPVModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalMinAssetNPVModule3 newCopy(CopyCache cache) {
        InGlobalMinAssetNPVModule3 copy = new InGlobalMinAssetNPVModule3();
        return Dev.throwException();
    }

    @Override
    public GlobalMinAssetNPVModule3 parse(IRPactInputParser parser) throws ParsingException {
        ...
        GlobalMinAssetNPVModule3 module = new GlobalMinAssetNPVModule3();
    ...
    private void applyPvFile(IRPactInputParser parser, GlobalMinAssetNPVModule3 module) throws ParsingException {
        if(hasPvFile()) {
