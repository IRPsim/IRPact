...
public class InPhaseUpdateModule_evalragraphnode2 implements InConsumerAgentEvalRAModule2 {
    ...
    public static void applyRes(TreeAnnotationResource res) {
        putClassPath(res, thisClass(), TreeViewStructure.PROCESS_MODEL4_PVACTMODULES_PVGENERAL_PHASEUPDATER);
    ...
    public InPhaseUpdateModule_evalragraphnode2 newCopy(CopyCache cache) {
        InPhaseUpdateModule_evalragraphnode2 copy = new InPhaseUpdateModule_evalragraphnode2();
