...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_PVGENERAL_DOADOPT;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_PVGENERAL_DOADOPT)
public class InDoAdoptModule3 implements InConsumerAgentEvalRAModule2 {
...
//            )
    ...
    public InDoAdoptModule3() {
    }

    public InDoAdoptModule3(String name) {
        setName(name);
    }

    @Override
    public InDoAdoptModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InDoAdoptModule3 newCopy(CopyCache cache) {
        InDoAdoptModule3 copy = new InDoAdoptModule3();
