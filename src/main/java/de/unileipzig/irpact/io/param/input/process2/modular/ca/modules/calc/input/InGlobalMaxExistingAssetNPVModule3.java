...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALAVGASSETNPV_GlobalMaxExistingAssetNPVModule3;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALAVGASSETNPV_GlobalMaxExistingAssetNPVModule3)
public class InGlobalMaxExistingAssetNPVModule3 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalMaxExistingAssetNPVModule3() {
    }

    public InGlobalMaxExistingAssetNPVModule3(String name) {
        setName(name);
    }

    public InGlobalMaxExistingAssetNPVModule3(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalMaxExistingAssetNPVModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalMaxExistingAssetNPVModule3 newCopy(CopyCache cache) {
        InGlobalMaxExistingAssetNPVModule3 copy = new InGlobalMaxExistingAssetNPVModule3();
        return Dev.throwException();
    }

    @Override
    public GlobalMaxExistingAssetNPVModule3 parse(IRPactInputParser parser) throws ParsingException {
        ...
        GlobalMaxExistingAssetNPVModule3 module = new GlobalMaxExistingAssetNPVModule3();
    ...
    private void applyPvFile(IRPactInputParser parser, GlobalMaxExistingAssetNPVModule3 module) throws ParsingException {
        if(hasPvFile()) {
