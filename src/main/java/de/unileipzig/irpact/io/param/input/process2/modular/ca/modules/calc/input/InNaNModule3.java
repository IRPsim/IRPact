...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_GENERALMODULES_NUMBERINPUT_NAN;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_GENERALMODULES_NUMBERINPUT_NAN)
public class InNaNModule3 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    @Override
    public InNaNModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InNaNModule3 newCopy(CopyCache cache) {
        InNaNModule3 copy = new InNaNModule3();
