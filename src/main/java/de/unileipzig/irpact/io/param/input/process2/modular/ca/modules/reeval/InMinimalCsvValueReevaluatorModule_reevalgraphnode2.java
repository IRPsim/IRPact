...
import static de.unileipzig.irpact.io.param.input.process2.modular.ca.MPM2Settings.CALC_EDGE_LABEL;
...
public class InMinimalCsvValueReevaluatorModule_reevalgraphnode2 implements InConsumerAgentReevaluationModule2 {
    ...
    public static void applyRes(TreeAnnotationResource res) {
        putClassPath(res, thisClass(), InRootUI.PROCESS_MODULAR3_MODULES_REEVAL_MINICSV);
    ...
    @FieldDefinition(
            graphEdge = @GraphEdge(
                    ...
                    tags = {"InMinimalCsvValueReevaluatorModule input"}
            )
    )
    ...
    public InMinimalCsvValueReevaluatorModule_reevalgraphnode2() {
    }

    @Override
    public InMinimalCsvValueReevaluatorModule_reevalgraphnode2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InMinimalCsvValueReevaluatorModule_reevalgraphnode2 newCopy(CopyCache cache) {
        InMinimalCsvValueReevaluatorModule_reevalgraphnode2 copy = new InMinimalCsvValueReevaluatorModule_reevalgraphnode2();
