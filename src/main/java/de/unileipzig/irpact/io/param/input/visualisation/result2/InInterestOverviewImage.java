...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.SETT_VISURESULT2_INTEREST;

/**
 * @author Daniel Abitz
 */
@Definition
@LocalizedUiResource.PutClassPath(SETT_VISURESULT2_INTEREST)
@LocalizedUiResource.XorWithoutUnselectRule
public class InInterestOverviewImage implements InLoggingResultImage2 {
    ...
    public InInterestOverviewImage(String name) {
        this();
        setName(name);
    }
    ...
    @Override
    public InInterestOverviewImage copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InInterestOverviewImage newCopy(CopyCache cache) {
