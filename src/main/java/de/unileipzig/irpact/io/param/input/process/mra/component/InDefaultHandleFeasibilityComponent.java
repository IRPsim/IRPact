...
@Definition
@ToRemove
public class InDefaultHandleFeasibilityComponent implements InEvaluableComponent {
    ...
    public static void applyRes(TreeAnnotationResource res) {
        putClassPath(res, thisClass(), TreeViewStructure.PROCESS_MRA_COMPONENTS_DEFFEAS);
    ...
    public InDefaultHandleFeasibilityComponent() {
    }

    @Override
    public InDefaultHandleFeasibilityComponent copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InDefaultHandleFeasibilityComponent newCopy(CopyCache cache) {
        InDefaultHandleFeasibilityComponent copy = new InDefaultHandleFeasibilityComponent();
