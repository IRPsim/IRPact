...
public class InAddScalarModule_calcgraphnode2 implements InConsumerAgentCalculationModule2 {
    ...
    public static void applyRes(TreeAnnotationResource res) {
        putClassPath(res, thisClass(), TreeViewStructure.PROCESS_MODEL4_GENERALMODULES_NUMBEREVAL_ADDSCALAR);
    ...
    public InAddScalarModule_calcgraphnode2() {
    }

    @Override
    public InAddScalarModule_calcgraphnode2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAddScalarModule_calcgraphnode2 newCopy(CopyCache cache) {
        InAddScalarModule_calcgraphnode2 copy = new InAddScalarModule_calcgraphnode2();
