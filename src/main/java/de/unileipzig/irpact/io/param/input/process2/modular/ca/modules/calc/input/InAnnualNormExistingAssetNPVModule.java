...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_InAnnualNormExistingAssetNPVModule;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_InAnnualNormExistingAssetNPVModule)
public class InAnnualNormExistingAssetNPVModule implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InAnnualNormExistingAssetNPVModule() {
    }

    public InAnnualNormExistingAssetNPVModule(String name) {
        setName(name);
    }

    public InAnnualNormExistingAssetNPVModule(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InAnnualNormExistingAssetNPVModule copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAnnualNormExistingAssetNPVModule newCopy(CopyCache cache) {
        InAnnualNormExistingAssetNPVModule copy = new InAnnualNormExistingAssetNPVModule();
        return Dev.throwException();
    }

    @Override
    public AnnualNormExistingAssetNPVModule parse(IRPactInputParser parser) throws ParsingException {
        ...
        AnnualNormExistingAssetNPVModule module = new AnnualNormExistingAssetNPVModule();
    ...
    private void applyPvFile(IRPactInputParser parser, AnnualNormExistingAssetNPVModule module) throws ParsingException {
        if(hasPvFile()) {
