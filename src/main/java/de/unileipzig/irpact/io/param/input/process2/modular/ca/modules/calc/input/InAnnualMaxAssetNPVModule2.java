...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMaxAssetNPVModule2;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMaxAssetNPVModule2)
public class InAnnualMaxAssetNPVModule2 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InAnnualMaxAssetNPVModule2() {
    }

    public InAnnualMaxAssetNPVModule2(String name) {
        setName(name);
    }

    public InAnnualMaxAssetNPVModule2(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InAnnualMaxAssetNPVModule2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAnnualMaxAssetNPVModule2 newCopy(CopyCache cache) {
        InAnnualMaxAssetNPVModule2 copy = new InAnnualMaxAssetNPVModule2();
        return Dev.throwException();
    }

    @Override
    public AnnualMaxAssetNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        AnnualMaxAssetNPVModule2 module = new AnnualMaxAssetNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, AnnualMaxAssetNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
