...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.SETT_VISURESULT2_COMPAREDCUMULATED;

/**
 * @author Daniel Abitz
 */
@Definition
@LocalizedUiResource.PutClassPath(SETT_VISURESULT2_COMPAREDCUMULATED)
@LocalizedUiResource.XorWithoutUnselectRule
public class InComparedCumulatedAnnualImage implements InLoggingResultImage2 {
    ...
    public static InComparedCumulatedAnnualImage createDefault() {
        return new InComparedCumulatedAnnualImage(IRPact.IMAGE_COMPARED_CUMULATED_ANNUAL_ADOPTIONS);
    }
...
//    )
    ...
    public InComparedCumulatedAnnualImage() {
    ...
    public InComparedCumulatedAnnualImage(String name) {
        this();
        setName(name);
    }
    ...
    @Override
    public InComparedCumulatedAnnualImage copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InComparedCumulatedAnnualImage newCopy(CopyCache cache) {
