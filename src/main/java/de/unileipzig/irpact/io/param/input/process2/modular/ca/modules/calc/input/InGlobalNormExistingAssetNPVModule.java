...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_InGlobalNormExistingAssetNPVModule;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_InGlobalNormExistingAssetNPVModule)
public class InGlobalNormExistingAssetNPVModule implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalNormExistingAssetNPVModule() {
    }

    public InGlobalNormExistingAssetNPVModule(String name) {
        setName(name);
    }

    public InGlobalNormExistingAssetNPVModule(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalNormExistingAssetNPVModule copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalNormExistingAssetNPVModule newCopy(CopyCache cache) {
        InGlobalNormExistingAssetNPVModule copy = new InGlobalNormExistingAssetNPVModule();
        return Dev.throwException();
    }

    @Override
    public GlobalNormExistingAssetNPVModule parse(IRPactInputParser parser) throws ParsingException {
        ...
        GlobalNormExistingAssetNPVModule module = new GlobalNormExistingAssetNPVModule();
    ...
    private void applyPvFile(IRPactInputParser parser, GlobalNormExistingAssetNPVModule module) throws ParsingException {
        if(hasPvFile()) {
