...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALAVGASSETNPV_GlobalMinExistingAssetNPVModule3;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALAVGASSETNPV_GlobalMinExistingAssetNPVModule3)
public class InGlobalMinExistingAssetNPVModule3 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalMinExistingAssetNPVModule3() {
    }

    public InGlobalMinExistingAssetNPVModule3(String name) {
        setName(name);
    }

    public InGlobalMinExistingAssetNPVModule3(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalMinExistingAssetNPVModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalMinExistingAssetNPVModule3 newCopy(CopyCache cache) {
        InGlobalMinExistingAssetNPVModule3 copy = new InGlobalMinExistingAssetNPVModule3();
        return Dev.throwException();
    }

    @Override
    public GlobalMinExistingAssetNPVModule3 parse(IRPactInputParser parser) throws ParsingException {
        ...
        GlobalMinExistingAssetNPVModule3 module = new GlobalMinExistingAssetNPVModule3();
    ...
    private void applyPvFile(IRPactInputParser parser, GlobalMinExistingAssetNPVModule3 module) throws ParsingException {
        if(hasPvFile()) {
