...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_GENERALMODULES_NUMBEREVAL_MULSCALAR;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_GENERALMODULES_NUMBEREVAL_MULSCALAR)
public class InMulScalarModule3 implements InConsumerAgentCalculationModule2 {
...
//            )
    ...
    public InMulScalarModule3() {
    }

    public InMulScalarModule3(String name) {
        setName(name);
    }

    @Override
    public InMulScalarModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InMulScalarModule3 newCopy(CopyCache cache) {
        InMulScalarModule3 copy = new InMulScalarModule3();
