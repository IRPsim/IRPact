...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_InGlobalNormAssetNPVModule;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_InGlobalNormAssetNPVModule)
public class InGlobalNormAssetNPVModule implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalNormAssetNPVModule() {
    }

    public InGlobalNormAssetNPVModule(String name) {
        setName(name);
    }

    public InGlobalNormAssetNPVModule(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalNormAssetNPVModule copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalNormAssetNPVModule newCopy(CopyCache cache) {
        InGlobalNormAssetNPVModule copy = new InGlobalNormAssetNPVModule();
        return Dev.throwException();
    }

    @Override
    public GlobalNormAssetNPVModule parse(IRPactInputParser parser) throws ParsingException {
        ...
        GlobalNormAssetNPVModule module = new GlobalNormAssetNPVModule();
    ...
    private void applyPvFile(IRPactInputParser parser, GlobalNormAssetNPVModule module) throws ParsingException {
        if(hasPvFile()) {
