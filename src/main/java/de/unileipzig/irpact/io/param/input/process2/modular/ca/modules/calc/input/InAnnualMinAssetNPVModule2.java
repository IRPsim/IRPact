...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMinAssetNPVModule2;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMinAssetNPVModule2)
public class InAnnualMinAssetNPVModule2 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InAnnualMinAssetNPVModule2() {
    }

    public InAnnualMinAssetNPVModule2(String name) {
        setName(name);
    }

    public InAnnualMinAssetNPVModule2(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InAnnualMinAssetNPVModule2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAnnualMinAssetNPVModule2 newCopy(CopyCache cache) {
        InAnnualMinAssetNPVModule2 copy = new InAnnualMinAssetNPVModule2();
        return Dev.throwException();
    }

    @Override
    public AnnualMinAssetNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        AnnualMinAssetNPVModule2 module = new AnnualMinAssetNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, AnnualMinAssetNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
