...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALMINNPV;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALMINNPV)
public class InGlobalMinAgentNPVModule2 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalMinAgentNPVModule2() {
    }

    public InGlobalMinAgentNPVModule2(String name) {
        setName(name);
    }

    public InGlobalMinAgentNPVModule2(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalMinAgentNPVModule2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalMinAgentNPVModule2 newCopy(CopyCache cache) {
        InGlobalMinAgentNPVModule2 copy = new InGlobalMinAgentNPVModule2();
        return Dev.throwException();
    }

    @Override
    public GlobalMinAgentNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        GlobalMinAgentNPVModule2 module = new GlobalMinAgentNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, GlobalMinAgentNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
