...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_GENERALMODULES_NUMBEREVAL_PRODUCT;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_GENERALMODULES_NUMBEREVAL_PRODUCT)
public class InProductModule3 implements InConsumerAgentCalculationModule2 {
...
//            )
    ...
    public InProductModule3() {
    }

    @Override
    public InProductModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InProductModule3 newCopy(CopyCache cache) {
        InProductModule3 copy = new InProductModule3();
