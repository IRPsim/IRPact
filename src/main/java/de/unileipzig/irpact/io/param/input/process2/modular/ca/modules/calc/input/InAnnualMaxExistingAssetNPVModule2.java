...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMaxExistingAssetNPVModule2;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMaxExistingAssetNPVModule2)
public class InAnnualMaxExistingAssetNPVModule2 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InAnnualMaxExistingAssetNPVModule2() {
    }

    public InAnnualMaxExistingAssetNPVModule2(String name) {
        setName(name);
    }

    public InAnnualMaxExistingAssetNPVModule2(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InAnnualMaxExistingAssetNPVModule2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAnnualMaxExistingAssetNPVModule2 newCopy(CopyCache cache) {
        InAnnualMaxExistingAssetNPVModule2 copy = new InAnnualMaxExistingAssetNPVModule2();
        return Dev.throwException();
    }

    @Override
    public AnnualMaxExistingAssetNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        AnnualMaxExistingAssetNPVModule2 module = new AnnualMaxExistingAssetNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, AnnualMaxExistingAssetNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
