...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALAVGASSETNPV;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALAVGASSETNPV)
public class InGlobalAvgAssetNPVModule3 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalAvgAssetNPVModule3() {
    }

    public InGlobalAvgAssetNPVModule3(String name) {
        setName(name);
    }

    public InGlobalAvgAssetNPVModule3(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalAvgAssetNPVModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalAvgAssetNPVModule3 newCopy(CopyCache cache) {
        InGlobalAvgAssetNPVModule3 copy = new InGlobalAvgAssetNPVModule3();
