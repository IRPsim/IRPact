 ...
 */
@Definition
public class InUncertaintySupplierReevaluator implements InReevaluator2 {
    ...
    @Override
    public InUncertaintySupplierReevaluator copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InUncertaintySupplierReevaluator newCopy(CopyCache cache) {
        InUncertaintySupplierReevaluator copy = new InUncertaintySupplierReevaluator();
