...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    @Override
    public AnnualAvgNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        AnnualAvgNPVModule2 module = new AnnualAvgNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, AnnualAvgNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
