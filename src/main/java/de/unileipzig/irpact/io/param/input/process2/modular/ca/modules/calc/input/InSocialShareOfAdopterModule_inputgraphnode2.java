...
public class InSocialShareOfAdopterModule_inputgraphnode2 implements InConsumerAgentInputModule2 {
    ...
    public static void applyRes(TreeAnnotationResource res) {
        putClassPath(res, thisClass(), TreeViewStructure.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_SOCIAL);
    ...
    public InSocialShareOfAdopterModule_inputgraphnode2 newCopy(CopyCache cache) {
        InSocialShareOfAdopterModule_inputgraphnode2 copy = new InSocialShareOfAdopterModule_inputgraphnode2();
