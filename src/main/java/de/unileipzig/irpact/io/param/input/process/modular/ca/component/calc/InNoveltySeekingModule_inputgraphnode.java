...
@ToRemove
public class InNoveltySeekingModule_inputgraphnode implements InConsumerAgentCalculationModule {
    ...
    public static void applyRes(TreeAnnotationResource res) {
        putClassPath(res, thisClass(), TreeViewStructure.PROCESS_MODULAR2_COMPONENTS_CALC_NOVSEEK);
    ...
    public InNoveltySeekingModule_inputgraphnode() {
    }

    @Override
    public InNoveltySeekingModule_inputgraphnode copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InNoveltySeekingModule_inputgraphnode newCopy(CopyCache cache) {
        InNoveltySeekingModule_inputgraphnode copy = new InNoveltySeekingModule_inputgraphnode();
    ...
    public AttributeInputModule parse(IRPactInputParser parser) throws ParsingException {
        ...
        module.setAttributeName(RAConstants.NOVELTY_SEEKING);
