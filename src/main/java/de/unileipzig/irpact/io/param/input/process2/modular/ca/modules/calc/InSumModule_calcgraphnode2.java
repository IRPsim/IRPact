...
public class InSumModule_calcgraphnode2 implements InConsumerAgentCalculationModule2 {
    ...
    public static void applyRes(TreeAnnotationResource res) {
        putClassPath(res, thisClass(), TreeViewStructure.PROCESS_MODEL4_GENERALMODULES_NUMBEREVAL_SUM);
    ...
    public InSumModule_calcgraphnode2 newCopy(CopyCache cache) {
        InSumModule_calcgraphnode2 copy = new InSumModule_calcgraphnode2();
