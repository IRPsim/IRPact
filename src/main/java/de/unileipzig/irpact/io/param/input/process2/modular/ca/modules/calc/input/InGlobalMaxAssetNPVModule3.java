...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALMAXASSETNPV;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALMAXASSETNPV)
public class InGlobalMaxAssetNPVModule3 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalMaxAssetNPVModule3() {
    }

    public InGlobalMaxAssetNPVModule3(String name) {
        setName(name);
    }

    public InGlobalMaxAssetNPVModule3(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalMaxAssetNPVModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalMaxAssetNPVModule3 newCopy(CopyCache cache) {
        InGlobalMaxAssetNPVModule3 copy = new InGlobalMaxAssetNPVModule3();
        return Dev.throwException();
    }

    @Override
    public GlobalMaxAssetNPVModule3 parse(IRPactInputParser parser) throws ParsingException {
        ...
        GlobalMaxAssetNPVModule3 module = new GlobalMaxAssetNPVModule3();
    ...
    private void applyPvFile(IRPactInputParser parser, GlobalMaxAssetNPVModule3 module) throws ParsingException {
        if(hasPvFile()) {
