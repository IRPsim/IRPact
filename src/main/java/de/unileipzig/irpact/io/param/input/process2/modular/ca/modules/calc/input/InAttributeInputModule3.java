...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_ATTR;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_ATTR)
public class InAttributeInputModule3 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InAttributeInputModule3(String name) {
        setName(name);
    }

    public InAttributeInputModule3(String name, InAttributeName attribute) {
        setName(name);
        setAttribute(attribute);
    }

    @Override
    public InAttributeInputModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAttributeInputModule3 newCopy(CopyCache cache) {
        InAttributeInputModule3 copy = new InAttributeInputModule3();
