...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALMAXNPV;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALMAXNPV)
public class InGlobalMaxAgentNPVModule2 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalMaxAgentNPVModule2() {
    }

    public InGlobalMaxAgentNPVModule2(String name) {
        setName(name);
    }

    public InGlobalMaxAgentNPVModule2(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalMaxAgentNPVModule2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalMaxAgentNPVModule2 newCopy(CopyCache cache) {
        InGlobalMaxAgentNPVModule2 copy = new InGlobalMaxAgentNPVModule2();
        return Dev.throwException();
    }

    @Override
    public GlobalMaxAgentNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        GlobalMaxAgentNPVModule2 module = new GlobalMaxAgentNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, GlobalMaxAgentNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
