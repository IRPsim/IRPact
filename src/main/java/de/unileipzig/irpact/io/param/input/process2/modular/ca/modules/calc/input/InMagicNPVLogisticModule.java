...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_InMagicNPVLogisticModule;

import de.unileipzig.irpact.commons.exception.ParsingException;
import de.unileipzig.irpact.core.logging.IRPLogging;
import de.unileipzig.irpact.core.logging.IRPSection;
import de.unileipzig.irpact.core.process.ra.npv.NPVXlsxData;
import de.unileipzig.irpact.core.process2.modular.ca.ra.modules.calc.input.MagicNPVLogisticModule;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_InMagicNPVLogisticModule)
public class InMagicNPVLogisticModule implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InMagicNPVLogisticModule() {
    }

    public InMagicNPVLogisticModule(String name) {
        setName(name);
    }

    public InMagicNPVLogisticModule(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InMagicNPVLogisticModule copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InMagicNPVLogisticModule newCopy(CopyCache cache) {
        InMagicNPVLogisticModule copy = new InMagicNPVLogisticModule();
        return Dev.throwException();
    }

    @Override
    public MagicNPVLogisticModule parse(IRPactInputParser parser) throws ParsingException {
        ...
        MagicNPVLogisticModule module = new MagicNPVLogisticModule();
        module.setName(getName());
        applyPvFile(parser, module);

        module.setNpvId(getNpvId());
        module.setL(getValueL());
        module.setK(getValueK());
        module.setX0(getX0());
        module.setMove(getMove());
        module.setScale(getScale());
        module.setNewRangeMin(getNewRangeMin());
        module.setNewRangeMax(getNewRangeMax());
    ...
    private void applyPvFile(IRPactInputParser parser, MagicNPVLogisticModule module) throws ParsingException {
        if(hasPvFile()) {
