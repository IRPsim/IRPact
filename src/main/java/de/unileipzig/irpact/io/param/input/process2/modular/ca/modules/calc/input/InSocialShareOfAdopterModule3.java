...
import de.unileipzig.irpact.core.process2.modular.ca.ra.modules.calc.input.SocialShareOfAdopterModule2;
...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_SOCIAL;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_SOCIAL)
public class InSocialShareOfAdopterModule3 implements InConsumerAgentInputModule2 {
    ...
    public InSocialShareOfAdopterModule3(String name) {
        setName(name);
    }

    @Override
    public InSocialShareOfAdopterModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InSocialShareOfAdopterModule3 newCopy(CopyCache cache) {
        InSocialShareOfAdopterModule3 copy = new InSocialShareOfAdopterModule3();
        return Dev.throwException();
    }

    @Override
    public SocialShareOfAdopterModule2 parse(IRPactInputParser parser) throws ParsingException {
