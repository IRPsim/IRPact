...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualAvgAgentNPVModule)
public class InAnnualAvgAgentNPVModule2 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InAnnualAvgAgentNPVModule2() {
    }

    public InAnnualAvgAgentNPVModule2(String name) {
        setName(name);
    }

    public InAnnualAvgAgentNPVModule2(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InAnnualAvgAgentNPVModule2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAnnualAvgAgentNPVModule2 newCopy(CopyCache cache) {
        InAnnualAvgAgentNPVModule2 copy = new InAnnualAvgAgentNPVModule2();
        return Dev.throwException();
    }

    @Override
    public AnnualAvgAgentNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        AnnualAvgAgentNPVModule2 module = new AnnualAvgAgentNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, AnnualAvgAgentNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
