...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMinExistingAssetNPVModule2;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMinExistingAssetNPVModule2)
public class InAnnualMinExistingAssetNPVModule2 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InAnnualMinExistingAssetNPVModule2() {
    }

    public InAnnualMinExistingAssetNPVModule2(String name) {
        setName(name);
    }

    public InAnnualMinExistingAssetNPVModule2(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InAnnualMinExistingAssetNPVModule2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAnnualMinExistingAssetNPVModule2 newCopy(CopyCache cache) {
        InAnnualMinExistingAssetNPVModule2 copy = new InAnnualMinExistingAssetNPVModule2();
        return Dev.throwException();
    }

    @Override
    public AnnualMinExistingAssetNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        AnnualMinExistingAssetNPVModule2 module = new AnnualMinExistingAssetNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, AnnualMinExistingAssetNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
