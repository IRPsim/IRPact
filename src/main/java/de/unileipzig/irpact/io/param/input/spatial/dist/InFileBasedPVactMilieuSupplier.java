...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.SPATIAL_DIST_FILE_FILEPOS_PVMILIEU;

/**
 * @author Daniel Abitz
 */
@Definition
@LocalizedUiResource.PutClassPath(SPATIAL_DIST_FILE_FILEPOS_PVMILIEU)
