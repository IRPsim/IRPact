...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_PVGENERAL_PHASEUPDATER;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_PVGENERAL_PHASEUPDATER)
public class InPhaseUpdateModule3 implements InConsumerAgentEvalRAModule2 {
...
//                    tags = {"InPhaseUpdateModule input"}
//            )
    ...
    public InPhaseUpdateModule3() {
    }

    public InPhaseUpdateModule3(String name) {
        setName(name);
    }

    @Override
    public InPhaseUpdateModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InPhaseUpdateModule3 newCopy(CopyCache cache) {
        InPhaseUpdateModule3 copy = new InPhaseUpdateModule3();
        return Dev.throwException();
    }

    @Override
    public PhaseUpdaterModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        PhaseUpdaterModule2 module = new PhaseUpdaterModule2();
