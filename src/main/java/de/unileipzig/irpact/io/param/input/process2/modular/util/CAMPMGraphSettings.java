...
public class CAMPMGraphSettings {
    ...
    public static final String ACTION_GRAPHNODE = "actiongraphnode2";
    ...
    public static final String BOOL_GRAPHNODE = "boolgraphnode2";
    ...
    public static final String CALC_GRAPHNODE = "calcgraphnode2";
