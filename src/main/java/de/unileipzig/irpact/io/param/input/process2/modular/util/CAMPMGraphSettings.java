package de.unileipzig.irpact.io.param.input.process2.modular.util;
 ...
 * @author Daniel Abitz
 */
public class CAMPMGraphSettings {
    ...
    public static final String BOOL_NODE = "boolnode3";
    ...
    public static final String CALC_NODE = "calcnode3";
    ...
    public static final String CALCLOG_NODE = "calclognode3";
    ...
    public static final String INPUT_NODE = "inputnode3";
    ...
    public static final String EVAL_NODE = "evalnode3";
    ...
    public static final String EVALRA_NODE = "evalranode3";
    ...
    public static final String REEVAL_NODE = "reevalnode3";
