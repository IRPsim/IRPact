...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALAVGNPV;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALAVGNPV)
public class InGlobalAvgNPVModule3 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalAvgNPVModule3() {
    }

    public InGlobalAvgNPVModule3(String name) {
        setName(name);
    }

    public InGlobalAvgNPVModule3(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalAvgNPVModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalAvgNPVModule3 newCopy(CopyCache cache) {
        InGlobalAvgNPVModule3 copy = new InGlobalAvgNPVModule3();
        return Dev.throwException();
    }

    @Override
    public GlobalAvgAgentNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        GlobalAvgAgentNPVModule2 module = new GlobalAvgAgentNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, GlobalAvgAgentNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
