...
public class InAvgFinModule_inputgraphnode2 implements InConsumerAgentInputModule2 {
    ...
    public static void applyRes(TreeAnnotationResource res) {
        putClassPath(res, thisClass(), TreeViewStructure.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AVGFIN);
    ...
    public InAvgFinModule_inputgraphnode2 newCopy(CopyCache cache) {
        InAvgFinModule_inputgraphnode2 copy = new InAvgFinModule_inputgraphnode2();
