...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALAVGASSETNPV_GlobalAvgExistingAssetNPVModule3;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_GLOBALAVGASSETNPV_GlobalAvgExistingAssetNPVModule3)
public class InGlobalAvgExistingAssetNPVModule3 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InGlobalAvgExistingAssetNPVModule3() {
    }

    public InGlobalAvgExistingAssetNPVModule3(String name) {
        setName(name);
    }

    public InGlobalAvgExistingAssetNPVModule3(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InGlobalAvgExistingAssetNPVModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InGlobalAvgExistingAssetNPVModule3 newCopy(CopyCache cache) {
        InGlobalAvgExistingAssetNPVModule3 copy = new InGlobalAvgExistingAssetNPVModule3();
        return Dev.throwException();
    }

    @Override
    public GlobalAvgExistingAssetNPVModule3 parse(IRPactInputParser parser) throws ParsingException {
        ...
        GlobalAvgExistingAssetNPVModule3 module = new GlobalAvgExistingAssetNPVModule3();
    ...
    private void applyPvFile(IRPactInputParser parser, GlobalAvgExistingAssetNPVModule3 module) throws ParsingException {
        if(hasPvFile()) {
