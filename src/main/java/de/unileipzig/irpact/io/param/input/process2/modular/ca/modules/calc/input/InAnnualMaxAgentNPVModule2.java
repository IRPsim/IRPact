...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMaxAgentNPVModule;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMaxAgentNPVModule)
public class InAnnualMaxAgentNPVModule2 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InAnnualMaxAgentNPVModule2() {
    }

    public InAnnualMaxAgentNPVModule2(String name) {
        setName(name);
    }

    public InAnnualMaxAgentNPVModule2(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InAnnualMaxAgentNPVModule2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAnnualMaxAgentNPVModule2 newCopy(CopyCache cache) {
        InAnnualMaxAgentNPVModule2 copy = new InAnnualMaxAgentNPVModule2();
        return Dev.throwException();
    }

    @Override
    public AnnualMaxAgentNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        AnnualMaxAgentNPVModule2 module = new AnnualMaxAgentNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, AnnualMaxAgentNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
