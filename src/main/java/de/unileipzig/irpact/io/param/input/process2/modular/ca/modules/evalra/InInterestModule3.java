...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_PVGENERAL_INTEREST;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_PVGENERAL_INTEREST)
public class InInterestModule3 implements InConsumerAgentEvalRAModule2 {
...
//            )
    ...
    public InInterestModule3() {
    }

    public InInterestModule3(String name) {
        setName(name);
    }

    @Override
    public InInterestModule3 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InInterestModule3 newCopy(CopyCache cache) {
        InInterestModule3 copy = new InInterestModule3();
