...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMinAgentNPVModule;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_AnnualMinAgentNPVModule)
public class InAnnualMinAgentNPVModule2 implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InAnnualMinAgentNPVModule2() {
    }

    public InAnnualMinAgentNPVModule2(String name) {
        setName(name);
    }

    public InAnnualMinAgentNPVModule2(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InAnnualMinAgentNPVModule2 copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAnnualMinAgentNPVModule2 newCopy(CopyCache cache) {
        InAnnualMinAgentNPVModule2 copy = new InAnnualMinAgentNPVModule2();
        return Dev.throwException();
    }

    @Override
    public AnnualMinAgentNPVModule2 parse(IRPactInputParser parser) throws ParsingException {
        ...
        AnnualMinAgentNPVModule2 module = new AnnualMinAgentNPVModule2();
    ...
    private void applyPvFile(IRPactInputParser parser, AnnualMinAgentNPVModule2 module) throws ParsingException {
        if(hasPvFile()) {
