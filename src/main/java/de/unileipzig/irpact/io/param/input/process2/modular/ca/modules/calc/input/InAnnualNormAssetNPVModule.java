...
import static de.unileipzig.irpact.io.param.input.TreeViewStructureEnum.PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_InAnnualNormAssetNPVModule;
...
@LocalizedUiResource.PutClassPath(PROCESS_MODEL4_PVACTMODULES_NUMBERINPUT_InAnnualNormAssetNPVModule)
public class InAnnualNormAssetNPVModule implements InConsumerAgentInputModule2 {
...
//        setShapeColorFillBorder(res, thisClass(), INPUT_SHAPE, INPUT_COLOR, INPUT_COLOR, INPUT_BORDER);
    ...
    public InAnnualNormAssetNPVModule() {
    }

    public InAnnualNormAssetNPVModule(String name) {
        setName(name);
    }

    public InAnnualNormAssetNPVModule(String name, InPVFile pvFile) {
        setName(name);
        setPvFile(pvFile);
    }

    @Override
    public InAnnualNormAssetNPVModule copy(CopyCache cache) {
        return cache.copyIfAbsent(this, this::newCopy);
    }

    public InAnnualNormAssetNPVModule newCopy(CopyCache cache) {
        InAnnualNormAssetNPVModule copy = new InAnnualNormAssetNPVModule();
        return Dev.throwException();
    }

    @Override
    public AnnualNormAssetNPVModule parse(IRPactInputParser parser) throws ParsingException {
        ...
        AnnualNormAssetNPVModule module = new AnnualNormAssetNPVModule();
    ...
    private void applyPvFile(IRPactInputParser parser, AnnualNormAssetNPVModule module) throws ParsingException {
        if(hasPvFile()) {
