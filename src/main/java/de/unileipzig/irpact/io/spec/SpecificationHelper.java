...
public class SpecificationHelper {
    ...
    public static SpecificationHelper of(JsonNode root) {
        return new SpecificationHelper(root);
    }
    ...
    public Iterable<SpecificationHelper> iterateElements() {
        return () -> new Iterator<SpecificationHelper>() {
            ...
            @Override
            public SpecificationHelper next() {
    ...
    public Iterable<Map.Entry<String, SpecificationHelper>> iterateFields() {
        return () -> new Iterator<Map.Entry<String, SpecificationHelper>>() {
            ...
            @Override
            public Map.Entry<String, SpecificationHelper> next() {
                Map.Entry<String, JsonNode> entry = iter.next();
                return new Pair<>(entry.getKey(), new SpecificationHelper(entry.getValue()));
            }
        };
    }
    ...
    public SpecificationHelper getOrCreateObject(String key1, String key2) {
        ObjectNode node1 = Util.getOrCreateObject(rootAsObject(), key1);
        ObjectNode node2 = Util.getOrCreateObject(node1, key2);
        return new SpecificationHelper(node2);
    }

    public SpecificationHelper getOrCreateArray(String key1, String key2) {
        ObjectNode node1 = Util.getOrCreateObject(rootAsObject(), key1);
    ...
    public SpecificationHelper addObject() {
        return new SpecificationHelper(addObjectNode());
    }
    ...
    public SpecificationHelper get(String field) {
        return new SpecificationHelper(root.get(field));
    }

    public SpecificationHelper getOrCreateObject(String field) {
        ObjectNode node = Util.getOrCreateObject(rootAsObject(), field);
        return new SpecificationHelper(node);
    }

    public SpecificationHelper getOrCreateArray(String field) {
    ...
    public SpecificationHelper getObject(String field1, String field2) throws ParsingException {
    ...
    public SpecificationHelper getObject(String field) throws ParsingException {
    ...
    public SpecificationHelper getArray(String field) throws ParsingException {
        JsonNode node = getNode(field);
