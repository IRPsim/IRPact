...
import de.unileipzig.irpact.io.spec2.impl.distribution.UnivariateDoubleDistributionSpec;
import de.unileipzig.irpact.io.spec2.impl.file.FilesSpec;
import de.unileipzig.irpact.io.spec2.impl.process.UncertaintyGroupAttributeSpec;
import de.unileipzig.irpact.io.spec2.impl.product.FixProductSpec;
import de.unileipzig.irpact.io.spec2.impl.product.ProductFindingSchemeSpec;
import de.unileipzig.irpact.io.spec2.impl.product.ProductGroupSpec;
import de.unileipzig.irpact.io.spec2.impl.product.ProductInterestSupplySchemeSpec;
import de.unileipzig.irpact.io.spec2.impl.spatial.dist.SpatialDistributionSpec;
 ...
 * @author Daniel Abitz
 */
public class SpecificationJob2 {

    protected final MultiCounter counter = new MultiCounter();
    protected JsonNodeCreator creator = IRPactJson.JSON.getNodeFactory();
    protected SpecificationCache2 cache;
    protected SpecificationData2 data;
    protected SpecificationConverter2 converter;

    protected Set<Class<?>> doInline = new HashSet<>();

    public SpecificationJob2(
            SpecificationCache2 cache,
            SpecificationData2 data,
            SpecificationConverter2 converter) {
        this.cache = cache;
        this.data = data;
    ...
    public SpecificationCache2 getCache() {
        return cache;
    }

    public SpecificationConverter2 getConverter() {
        return converter;
    }

    public SpecificationData2 getData() {
        return data;
    }
    ...
    public <T> void callToSpec(T input) throws ParsingException {
        ...
        ToSpecConverter2<T> toSpec = converter.getToSpecConverter(c);
