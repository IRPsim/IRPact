 ...
 * @author Daniel Abitz
 */
public class SpecificationData2 {
    ...
    private static final IRPLogger LOGGER = IRPLogging.getLogger(SpecificationData2.class);
    ...
    public SpecificationData2() {
        this(IRPactJson.JSON);
    }

    public SpecificationData2(ObjectMapper mapper) {
        this.mapper = mapper;
        init();
    }
