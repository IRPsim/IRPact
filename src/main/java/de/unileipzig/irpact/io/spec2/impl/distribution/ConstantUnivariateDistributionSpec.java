...
public class ConstantUnivariateDistributionSpec extends AbstractSubSpec<InConstantUnivariateDistribution> {
    ...
    @Override
    public InConstantUnivariateDistribution[] toParamArray(SpecificationJob2 job) throws ParsingException {
        throw new UnsupportedOperationException();
    }

    @Override
    public InConstantUnivariateDistribution toParam(SpecificationHelper2 rootSpec, SpecificationJob2 job) throws ParsingException {
    ...
    @Override
    public void toSpec(InConstantUnivariateDistribution input, SpecificationJob2 job) throws ParsingException {
        toSpecIfNotExists(input.getName(), job.getData().getDistributions(), input, job);
    }

    @Override
    protected void create(InConstantUnivariateDistribution input, SpecificationHelper2 rootSpec, SpecificationJob2 job) throws ParsingException {
