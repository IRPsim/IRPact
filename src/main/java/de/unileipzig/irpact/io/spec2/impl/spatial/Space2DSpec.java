...
public class Space2DSpec extends AbstractSubSpec<InSpace2D> {
    ...
    @Override
    public InSpace2D[] toParamArray(SpecificationJob2 job) throws ParsingException {
        return toParamArray(job.getData().getSpatialModel(), job);
    }

    @Override
    public InSpace2D toParam(SpecificationHelper2 rootSpec, SpecificationJob2 job) throws ParsingException {
    ...
    @Override
    public void toSpec(InSpace2D input, SpecificationJob2 job) throws ParsingException {
        create(input, job.getData().getSpatialModel(), job);
    }

    @Override
    protected void create(InSpace2D input, SpecificationHelper2 rootSpec, SpecificationJob2 job) throws ParsingException {
