...
import de.unileipzig.irpact.io.param.input.process.InNameBasedUncertaintyWithConvergenceGroupAttribute;
...
public class NameBasedUncertaintyWithConvergenceGroupAttributeSpec extends AbstractSubSpec<InNameBasedUncertaintyWithConvergenceGroupAttribute> {
    ...
    @Override
    public InNameBasedUncertaintyWithConvergenceGroupAttribute[] toParamArray(SpecificationJob2 job) throws ParsingException {
        return toParamArray(job.getData().getSpatialModel(), job);
    }

    @Override
    public InNameBasedUncertaintyWithConvergenceGroupAttribute toParam(SpecificationHelper2 rootSpec, SpecificationJob2 job) throws ParsingException {
    ...
    @Override
    public void toSpec(InNameBasedUncertaintyWithConvergenceGroupAttribute input, SpecificationJob2 job) throws ParsingException {
        create(input, job.getData().getSpatialModel(), job);
    }

    @Override
    protected void create(InNameBasedUncertaintyWithConvergenceGroupAttribute input, SpecificationHelper2 rootSpec, SpecificationJob2 job) throws ParsingException {
