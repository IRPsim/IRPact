...
public class RAProcessModelSpec extends AbstractSubSpec<InRAProcessModel> {
    ...
    @Override
    public InRAProcessModel[] toParamArray(SpecificationJob2 job) throws ParsingException {
        return toParamArray(job.getData().getSpatialModel(), job);
    }

    @Override
    public InRAProcessModel toParam(SpecificationHelper2 rootSpec, SpecificationJob2 job) throws ParsingException {
    ...
    @Override
    public void toSpec(InRAProcessModel input, SpecificationJob2 job) throws ParsingException {
        create(input, job.getData().getSpatialModel(), job);
    }

    @Override
    protected void create(InRAProcessModel input, SpecificationHelper2 rootSpec, SpecificationJob2 job) throws ParsingException {
