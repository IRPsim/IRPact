...
public final class GnuPlotFactory {
    ...
    public static GnuPlotBuilder lineChart1(BuilderSettings settings) {
        ...
        if(settings.hasTitle()) builder.setTitle(settings.nonNull().getTitle());
        builder.setXLabel(settings.nonNull().getXLab());
        builder.setYLabel(settings.nonNull().getYLab());
    ...
    public static GnuPlotBuilder stackedBarChart0(BuilderSettings settings) {
        ...
        if(settings.hasFillLab()) builder.setLegendOutsideRightTop(settings.nonNull().getFillLab());
