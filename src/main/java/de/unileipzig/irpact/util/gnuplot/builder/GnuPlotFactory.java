...
public final class GnuPlotFactory {
    ...
    public static GnuPlotBuilder stackedBarChart1(BuilderSettings settings) {
        GnuPlotBuilder builder = newBuilder();
        builder.add(getAutoGenerated());
        ...
        builder.addComment("===plot===");
        builder.setDataFileSeparator(settings.nonNull().getSep());
        builder.plotRawSpecialLinePlotWithKey(
                settings.nonNull().getPhase0(),
                settings.nonNull().getPhase1(),
                settings.nonNull().getPhase2(),
                settings.useArgsFlag() ? GnuPlotBuilder.arg(1) : GnuPlotBuilder.quote(settings.getInputFile()),
                1
        );
        return builder;
    }
