 ...
 * @author Daniel Abitz
 */
public class ModularImageDemo2 extends AbstractScenario {

    public static final int REVISION = 1;

    public ModularImageDemo2(String name, String creator, String description) {
    ...
    public List<InRoot> createInRoots() {
        ...
        evalModule.setDecisionMakingModule(decisionMakingComponent);
