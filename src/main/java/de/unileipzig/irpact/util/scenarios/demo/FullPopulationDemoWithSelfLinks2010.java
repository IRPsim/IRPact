 ...
 * @author Daniel Abitz
 */
public class FullPopulationDemoWithSelfLinks2010 extends AbstractPVactScenario {

    public static final int REVISION = 0;

    public FullPopulationDemoWithSelfLinks2010(String name, String creator, String description) {
    ...
    public List<InRoot> createInRoots() {
        ...
        root.getGeneral().setFirstSimulationYear(2010);
