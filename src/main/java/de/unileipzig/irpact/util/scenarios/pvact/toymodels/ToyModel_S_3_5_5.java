 ...
 * @author Daniel Abitz
 */
public class ToyModel_S_3_5_5 extends AbstractToyModel {

    public static final int REVISION = 0;

    public ToyModel_S_3_5_5(String name, String creator, String description, BiConsumer<InRoot, OutRoot> resultConsumer) {
    ...
    protected void setToyModelInputFile() {
        setSpatialDataName("Datensatz_ToyModel_S_3_5_5");
    }
    ...
    protected void customProcessModelSetup(ToyModeltModularProcessModelTemplate mpm) {
        ...
        mpm.getNovWeightModule().setScalar(1.0/3.0);
    }
}
