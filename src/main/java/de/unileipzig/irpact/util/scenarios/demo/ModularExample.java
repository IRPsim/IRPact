 ...
 * @author Daniel Abitz
 */
public class ModularExample extends AbstractScenario {

    public static final int REVISION = 1;

    public ModularExample(String name, String creator, String description) {
    ...
    public List<InRoot> createInRootsOLD() {
        ...
        //process
        InAttributeInputModule_inputgraphnode attr1 = new InAttributeInputModule_inputgraphnode("AnzahlArme", getAttributeName("Arme"));
        InAttributeInputModule_inputgraphnode attr2 = new InAttributeInputModule_inputgraphnode("AnzahlBeine", getAttributeName("Beine"));
        InAddModule_calcgraphnode add = new InAddModule_calcgraphnode("AddGlieder", attr1, attr2);

        InDisaggregatedNPVModule_inputgraphnode npvInput = new InDisaggregatedNPVModule_inputgraphnode("DisaggregatedNPV", 1.25, pvFile);
        InDisaggregatedFinancialModule_inputgraphnode ftInput = new InDisaggregatedFinancialModule_inputgraphnode("DisaggregatedFinancial", 1.25);
        InAddModule_calcgraphnode add2 = new InAddModule_calcgraphnode("AddBarwertFinanz", npvInput, ftInput);

        InNPVModule_inputgraphnode rawNPV = new InNPVModule_inputgraphnode("SimpleNPV", pvFile);
