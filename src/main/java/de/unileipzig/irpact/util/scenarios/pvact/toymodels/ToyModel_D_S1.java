...
public class ToyModel_D_S1 extends AbstractToyModel {
    ...
    public ToyModel_D_S1(BiConsumer<InRoot, OutRoot> resultConsumer) {
        super(resultConsumer);
        init();
    }

    public ToyModel_D_S1(String name, String creator, String description, BiConsumer<InRoot, OutRoot> resultConsumer) {
