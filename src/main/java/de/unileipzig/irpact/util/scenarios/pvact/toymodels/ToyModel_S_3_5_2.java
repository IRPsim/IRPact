...
public class ToyModel_S_3_5_2 extends AbstractToyModel {

    public static final int REVISION = 0;

    public ToyModel_S_3_5_2(String name, String creator, String description, BiConsumer<InRoot, OutRoot> resultConsumer) {
    ...
    protected void setToyModelInputFile() {
        setSpatialDataName("Datensatz_ToyModel_S_3_5_2");
    }
