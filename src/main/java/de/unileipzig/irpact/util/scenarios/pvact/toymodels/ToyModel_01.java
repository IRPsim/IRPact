 ...
 * @author Daniel Abitz
 */
public class ToyModel_01 extends AbstractToyModel {
    ...
    public ToyModel_01(String name, String creator, String description, BiConsumer<InRoot, OutRoot> resultConsumer) {
