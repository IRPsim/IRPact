...
import de.unileipzig.irpact.io.param.input.process.mra.component.InDefaultDoActionComponent;
import de.unileipzig.irpact.io.param.input.process.mra.component.InDefaultHandleDecisionMakingComponent;
import de.unileipzig.irpact.io.param.input.process.mra.component.InDefaultHandleFeasibilityComponent;
import de.unileipzig.irpact.io.param.input.process.mra.component.InDefaultHandleInterestComponent;
 ...
 * @author Daniel Abitz
 */
public class ModularImageDemo extends AbstractScenario {

    public static final int REVISION = 1;

    public ModularImageDemo(String name, String creator, String description) {
    ...
    public List<InRoot> createInRootsOLD() {
        ...
        InDefaultHandleInterestComponent interestComponent = new InDefaultHandleInterestComponent();
        interestComponent.setName("INTEREST");
        interestComponent.setDefaultValues();

        InDefaultHandleFeasibilityComponent feasibilityComponent = new InDefaultHandleFeasibilityComponent();
        feasibilityComponent.setName("FEASIBILITY");
        feasibilityComponent.setDefaultValues();

        InDefaultHandleDecisionMakingComponent decisionMakingComponent = new InDefaultHandleDecisionMakingComponent();
        decisionMakingComponent.setName("DECISION");
        decisionMakingComponent.setDefaultValues();
        decisionMakingComponent.setPvFile(pvFile);

        InDefaultDoActionComponent actionComponent = new InDefaultDoActionComponent();
        actionComponent.setName("ACTION");
        actionComponent.setDefaultValues();

        processModel.setInterestComponent(interestComponent);
        processModel.setFeasibilityComponent(feasibilityComponent);
        processModel.setDecisionMakingComponent(decisionMakingComponent);
        processModel.setActionComponent(actionComponent);
