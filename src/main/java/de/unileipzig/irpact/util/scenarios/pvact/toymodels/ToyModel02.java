 ...
 * @author Daniel Abitz
 */
public class ToyModel02 extends AbstractToyModel {
    ...
    public ToyModel02(String name, BiConsumer<InRoot, OutRoot> resultConsumer) {
        this(name, null, null, resultConsumer);
    }

    public ToyModel02(String name, String creator, String description, BiConsumer<InRoot, OutRoot> resultConsumer) {
