...
public class ToyModel_S_3_4_1 extends AbstractToyModel {
    ...
    public ToyModel_S_3_4_1(String name, String creator, String description, BiConsumer<InRoot, OutRoot> resultConsumer) {
    ...
    protected void setToyModelInputFile() {
        setSpatialDataName("Datensatz_ToyModel_S_3_4_1");
    }
