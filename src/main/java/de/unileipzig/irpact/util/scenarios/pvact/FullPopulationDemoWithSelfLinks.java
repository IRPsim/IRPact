 ...
 * @author Daniel Abitz
 */
public class FullPopulationDemoWithSelfLinks extends AbstractPVactScenario {

    public static final int REVISION = 1;

    public FullPopulationDemoWithSelfLinks(String name, String creator, String description) {
