...
public class SimulationAgent implements IRPactAgent, KillPlatformService {

    public static final String FILE_NAME = "de.unileipzig.irpact.agent.SimulationAgent.class";
