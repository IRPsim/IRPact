package de.unileipzig.irpact.jadex.examples.deprecated.old.mapAccess;
...
public class Starter {
    ...
    private static CreationInfo createConsumerAgentBDIInfo(
        ...
        info.setName(name);
        info.setFilename("de.unileipzig.irpact.jadex.examples.old.mapAccess.ConsumerAgentBDI.class");
