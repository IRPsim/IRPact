...
import de.unileipzig.irpact.core.postprocessing.image3.base.AbstractAnnualInterestImageHandler;
 ...
 * @author Daniel Abitz
 */
public class AnnualInterestGnuplotImageHandler
        extends AbstractAnnualInterestImageHandler
        implements GnuplotHelperAPI<InAnnualInterestImage> {

    private static final IRPLogger LOGGER = IRPLogging.getLogger(AnnualInterestGnuplotImageHandler.class);

    public AnnualInterestGnuplotImageHandler(
            ImageProcessor2 processor,
            InAnnualInterestImage imageConfiguration) {
    ...
    @Override
    public GnuPlotBuilder getBuilder(InAnnualInterestImage image, ImageData data) throws Throwable {
    ...
    @Override
    public ImageData createData(InAnnualInterestImage image) throws Throwable {
