 ...
 * @author Daniel Abitz
 */
public abstract class AbstractAnnualInterestImageHandler
        extends AbstractImageHandler<InAnnualInterestImage>
        implements LoggingHelper {

    public AbstractAnnualInterestImageHandler(
