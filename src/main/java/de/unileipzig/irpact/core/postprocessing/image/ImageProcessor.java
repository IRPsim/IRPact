        ...
        switch (image.getMode()) {
            case ANNUAL_ZIP:
                return GnuPlotFactory.lineChart0(
                        createBuilderSettingsForZipLineChart(image, getLocalizedImage())
                );

            case COMPARED_ANNUAL_ZIP:
                return GnuPlotFactory.interactionLineChart0(
                        createBuilderSettingsForInteractionZipLineChart(image, getLocalizedImage())
                );

            case CUMULATIVE_ANNUAL_PHASE:
                return GnuPlotFactory.stackedBarChart0(
                        createBuilderSettingsForPhaseStackedBar(image, getLocalizedImage())
                );
        ...
        switch (image.getMode()) {
            case ANNUAL_ZIP:
                return RScriptFactory.lineChart0(
                        createBuilderSettingsForZipLineChart(image, getLocalizedImage()).setScaleXContinuousBreaks(getYearBreaksForPrettyR())
                );

            case COMPARED_ANNUAL_ZIP:
                return RScriptFactory.interactionLineChart0(
                        createBuilderSettingsForInteractionZipLineChart(image, getLocalizedImage()).setScaleXContinuousBreaks(getYearBreaksForPrettyR())
                );

            case CUMULATIVE_ANNUAL_PHASE:
                return RScriptFactory.stackedBarChart0(
                        createBuilderSettingsForPhaseStackedBar(image, getLocalizedImage()).setScaleXContinuousBreaks(getYearBreaksForPrettyR())
                );
