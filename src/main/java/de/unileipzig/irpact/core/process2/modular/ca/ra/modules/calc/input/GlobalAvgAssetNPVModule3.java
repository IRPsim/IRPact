 ...
 * @author Daniel Abitz
 */
public class GlobalAvgAssetNPVModule3
        extends AbstractCACalculationModule2
        implements RAHelperAPI2 {

    private static final IRPLogger LOGGER = IRPLogging.getLogger(GlobalAvgAssetNPVModule3.class);
    ...
    public double calculate(ConsumerAgentData2 input, List<PostAction2> actions) throws Throwable {
        ...
        return dataSupplier.globalAvgAssetNPV(start, end);
    }
}
