 ...
 * @author Daniel Abitz
 */
public class AnnualNormAssetNPVModule
        extends AbstractCACalculationModule2
        implements RAHelperAPI2 {

    private static final IRPLogger LOGGER = IRPLogging.getLogger(AnnualNormAssetNPVModule.class);
    ...
    public double calculate(ConsumerAgentData2 input, List<PostAction2> actions) throws Throwable {
        ...
        double min = dataSupplier.annualMinAssetNPV(getCurrentYear(input));
        double max = dataSupplier.annualMaxAssetNPV(getCurrentYear(input));
