 ...
 * @author Daniel Abitz
 */
public class GlobalNormAssetNPVModule
        extends AbstractCACalculationModule2
        implements RAHelperAPI2 {

    private static final IRPLogger LOGGER = IRPLogging.getLogger(GlobalNormAssetNPVModule.class);
    ...
    public double calculate(ConsumerAgentData2 input, List<PostAction2> actions) throws Throwable {
        ...
        double min = dataSupplier.globalMinAssetNPV(start, end);
        double max = dataSupplier.globalMaxAssetNPV(start, end);
