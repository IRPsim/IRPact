...
public interface LoggingHelper {
    ...
    default void trace(IRPSection section, String format, Object arg) {
        getDefaultLogger().trace(section, format, arg);
    }
    ...
    default void trace(IRPSection section, String format, Object... args) {
        getDefaultLogger().trace(section, format, args);
    }
