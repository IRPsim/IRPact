...
public class BasicDataLogger implements DataLogger {
    ...
    @Override
    public void logEvaluationFailed(ConsumerAgent agent, Product product, Timestamp stamp, AgentDataState data) {
        throw new RuntimeException();
    }

    @Override
    public void logEvaluationSuccess(ConsumerAgent agent, Product product, Timestamp stamp, AgentDataState data) {
        throw new RuntimeException();
    }
