 ...
 * @author Daniel Abitz
 */
public class PredefinedSimulationTask extends PredefinedBinaryTask implements SimulationTask {

    private static final IRPLogger LOGGER = IRPLogging.getLogger(PredefinedSimulationTask.class);
    ...
    public PredefinedSimulationTask() {
        super(IRPactJson.SMILE.createObjectNode());
        setInfo(NO_INFO);
        setTask(NO_TASK);
    }

    public PredefinedSimulationTask(byte[] content) throws IOException {
