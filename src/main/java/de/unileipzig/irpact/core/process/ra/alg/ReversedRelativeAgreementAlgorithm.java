...
public class ReversedRelativeAgreementAlgorithm extends AbstractRelativeAgreementAlgorithm {
    ...
    public boolean apply(
        ...
        //1 influences 2
        boolean influenced2 = DefaultRelativeAgreementAlgorithm.applyReverse(isLogData(), m2, name1, o1, u1, name2, o2, u2, opinion2, uncertainty2);
        //2 influences 1
        boolean influenced1 = DefaultRelativeAgreementAlgorithm.applyReverse(isLogData(), m1, name2, o2, u2, name1, o1, u1, opinion1, uncertainty1);
