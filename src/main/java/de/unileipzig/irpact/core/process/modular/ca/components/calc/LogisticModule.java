...
public class LogisticModule
    ...
    private static final IRPLogger LOGGER = IRPLogging.getLogger(LogisticModule.class);
    ...
    public double calculate(ConsumerAgentData input) throws Throwable {
        ...
        double logistic = MathUtil.logistic(result);
        return getWeight() * logistic;
    }
}
