...
public final class RAConstants {
    ...
    public static final double DEFAULT_SPEED_OF_CONVERGENCE = 0.1;
    public static final double DEFAULT_ATTIDUTE_GAP = 0.1;
    ...
    public static final double DEFAULT_MODERATE_UNCERTAINTY = 0.4;
    public static final double DEFAULT_EXTREMIST_UNCERTAINTY = 0.21;
