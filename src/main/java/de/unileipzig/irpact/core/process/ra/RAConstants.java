...
public final class RAConstants {
    ...
    public static final String SHARE_1_2_HOUSE = "share_1_2_house";                         //A5 -> boolean
    public static final String HOUSE_OWNER = "house_owner";                       //A6 -> boolean
    ...
    public static final String ADOPTION_THRESHOLD = "adoption_threshold";               //D44";               //D4
