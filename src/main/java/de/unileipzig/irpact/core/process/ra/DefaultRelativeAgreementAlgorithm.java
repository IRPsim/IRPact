 ...
 * @author Daniel Abitz
 */
public class DefaultRelativeAgreementAlgorithm extends NameableBase implements RelativeAgreementAlgorithm {

    public static final DefaultRelativeAgreementAlgorithm INSTANCE = new DefaultRelativeAgreementAlgorithm();
