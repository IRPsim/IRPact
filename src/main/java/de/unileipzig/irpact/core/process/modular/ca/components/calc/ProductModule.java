 ...
 * @author Daniel Abitz
 */
public class ProductModule extends AbstractConsumerAgentModule implements ConsumerAgentCalculationModule {

    private static final IRPLogger LOGGER = IRPLogging.getLogger(ProductModule.class);
    ...
    public double calculate(ConsumerAgentData input) throws Throwable {
        ...
        for(ConsumerAgentCalculationModule module: getModules()) {
            product *= module.calculate(input);
        }
